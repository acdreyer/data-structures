...
var zoneNo = '3';  //change this value for each zone...
...
String.prototype.capitalize = function() {
    ...
    chartemp = chartemp.replace('Pm','PM');
    chartemp = chartemp.replace('Aa','AA');
    chartemp = chartemp.replace('N.y.u.','N.Y.U.');
    return chartemp;
}
...
String.prototype.cleanbuildingname = function(){
    ...
    chartemp = chartemp.replace('125 - two for one','125 Two for One'); //zone 8
        chartemp = chartemp.replace('pm','PM'); //zone 8
    return chartemp;
}
...
// ------------------------------------------------------------------------
            ...
            meetingnametemp = meetingnametemp.replace(':','').cleanbuildingname(); //this should have its own cleanmeeting...
